...
//	@Scheduled(fixedDelay = 5400000)
	...
	private void sendEmailvalidation(String mail,String name, String randomStringNumber) throws MessagingException {
		...
		helper.setText("<html>" + "<body>"
				...
				+ "<br>"
				+ "Antes de contarte más, por estar dentro de los 1000 primeros miembros de la comunidad, te invitamos a descargarte el material exclusivo que te prometimos: Como pasar de ahorrista a inversor: Guiá práctica de pasos claves. Haz click aquí para descargarlo. <br>"
				+ "<br>"
