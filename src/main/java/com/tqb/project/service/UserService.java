...
//	@Scheduled(fixedDelay = 5400000)
	...
	private void sendEmailvalidation(String mail,String name, String randomStringNumber) throws MessagingException {
		...
		helper.setText("<html>" + "<body>"
				...
				+ "<br>"
				+ "Antes de contarte más, por estar dentro de los 1000 primeros miembros de la comunidad, te invitamos a descargarte el material exclusivo que te prometimos: Como pasar de ahorrista a inversor: Guiá práctica de pasos claves. Haz click<a href=\"http://www.thequalitybridgeblog.com/KeySteps.pdf\" target=\"_blank\"> aquí</a>\n"
				+ " para descargarlo. <br>"
				+ "<br>"
				...
				+ "<br>"
				+ "<br>"
				+ "Como miembro registrado ahora podrás consultar y solicitar la información completa de los proyectos de inversión. Haz click aquí y contáctanos.   <br>"
				+ "<br>"
				+ "The Quality Blog: Con frecuencia semanal podrás ver notas, recomendaciones, consejos y análisis, escritos por nuestro equipo de profesionales y reconocidos periodistas de los medios más importantes. Sobre distintos temas: Economía, Mercado, Real Estate, Finanzas y mucho más. Haz click aquí para ingresar. <br>"
				+ "<br>"
				+ "PRÓXIMAMENTE <br>"
				+ "<br>"
				+ "Ciclo de Webinars: Próximamente presentaremos ciclos de webinars para ampliar tu visión como inversor. ¡Estate atento! <br>"
				+ "<br>"
